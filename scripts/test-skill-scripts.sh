...
echo "[check] GA4 MCP server tests"
...
echo "[check] Governed Ad Platform Executor tests"
node --test "$ROOT/tools-mcp/adtech/ad-platform-executor-template/tests/ad_platform_executor.test.mjs"
